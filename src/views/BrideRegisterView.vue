<template>
  <div class="container mx-auto px-4 py-8">
    <div class="max-w-3xl mx-auto">
      <div class="card mb-8">
        <h1 class="text-3xl font-bold text-secondary-700 mb-6">تسجيل عروس</h1>
        ...
        <form @submit.prevent="submitForm">
          ...
          <div class="mb-8">
            <h2 class="text-xl font-semibold text-gray-700 mb-4">مواصفات الزوج المطلوب</h2>
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div class="form-group">
              ...
              <div class="form-group">
                <label for="preferredIncome" class="label">الدخل الشهري</label>
                <select 
                  id="preferredIncome"
                  v-model="formData.preferredTraits.income"
                  class="input-field"
                  required
                >
          ...
          <div class="form-group">
            <div class="flex items-start mb-4">
              ...
              <label for="terms" class="mr-2 text-sm font-medium text-gray-700">
                أوافق على <router-link to="/terms" class="text-secondary-600 hover:underline">الشروط والأحكام</router-link> وأقر بصحة المعلومات المقدمة
              </label>
            </div>
          </div>
